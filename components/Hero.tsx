      ...
      <div className='flex justify-center relative my-20'>
        <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex-col items-center justify-center'>
          <h2 className='uppercase tracking-widest, text-xs text-center text-blue-100'>
            Développer des solutions innovantes avec Flutter
          </h2>
          <TextGenerateEffect
            className='text-center text-[40px] md:text-5xl lg:text-6xl'
            words='Convertir des idées en expériences utilisateur harmonieuses'
          />
          <p className='text-center md:tracking-wider mb-4 text-lg md:text-lg lg:text-2xl'>
            Bonjour
            je suis Marcott, développeur Flutter basé en RD Congo
          </p>
          <a href='#about'>
            <MagicButton
